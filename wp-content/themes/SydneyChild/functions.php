<?php
/*Ce fichier fait partie deSydneyChild, sydney child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function SydneyChild_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'SydneyChild_enqueue_child_styles' );
