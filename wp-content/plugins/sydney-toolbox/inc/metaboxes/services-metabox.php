...
class Sydney_Toolbox_Services {
	...
	?>
		...
		<p><em><?php echo __('Example: <strong>fa-android</strong>. Full list of icons is <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank">here</a>', 'sydney-toolbox'); ?></em></p>
		...
		<p><em><?php echo __('You can link your service to a page of your choice by entering the URL in this field', 'sydney-toolbox'); ?></em></p>
