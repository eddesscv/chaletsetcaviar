...
= 2.18.1 =
* Fixed: Formatting issue with Post Blocks widget after recent update.
* Fixed: Temporarily revoked Dynamicc Rules for widgets. It is causing issues with some of the widgets.
